function [  ] = plot_temporary_group( DATA_FRAMES, matPOSITIONS, nAG, frame, G )
    ...
    scatter(temp(:,1),temp(:,2), 35, 'b', 'filled', 'o');
    scatter(CENTROID(1),CENTROID(2), 1, 'b', 'filled', 'o');

    for A = 1 : nAG
        
        line([CENTROID(1), temp(A,1)], [CENTROID(2), temp(A,2)], 'color', 'b', 'LineWidth', 0.8);
